...
export const Shapes = {
   ...
   */
  cube: (size = 100, position = [0, 0, 0], rotation = [0, 0, 0], scale = [1, 1, 1], color = [1, 0, 0]) => {
    const mesh = meshMaker.boxConstructor(size, size, size)
    mesh.color = color
    return new object(mesh, position, rotation, scale)
  },
   ...
   */
  box: (width = 100, height = 100, length = 100, position = [0, 0, 0], rotation = [0, 0, 0], scale = [1, 1, 1], color = [1, 0, 0]) => {
   ...
   */
  sphere: (radius = 50, latBands = 12, longBands = 12, position = [0, 0, 0], rotation = [0, 0, 0], scale = [1, 1, 1], color = [0.7, 0.7, 1]) => {
   ...
   */
  cylinder: (radius = 25, height = 100, radialSegments = 16, position = [0, 0, 0], rotation = [0, 0, 0], scale = [1, 1, 1], color = [0.8, 0.8, 0.8]) => {
   ...
   */
  pyramid: (width = 100, height = 100, position = [0, 0, 0], rotation = [0, 0, 0], scale = [1, 1, 1], color = [1, 0.5, 0]) => {
   ...
   */
  plane: (width = 100, height = 100, position = [0, 0, 0], rotation = [0, 0, 0], scale = [1, 1, 1], color = [0.2, 0.8, 0.2]) => {
   ...
   */
  ground: (size = 1000, position = [0, -100, 0], color = [0.3, 0.6, 0.3]) => {
    const mesh = meshMaker.rectangleConstructor(size, size)
    mesh.color = color
    return new object(mesh, position, [0, 0, 0], [1, 1, 1])
  },
   ...
   */
  wall: (width = 100, height = 100, position = [0, 0, 0], rotation = [0, 0, 0], color = [0.8, 0.8, 0.8]) => {
    const mesh = meshMaker.rectangleConstructor(width, height)
    mesh.color = color
    return new object(mesh, position, rotation, [1, 1, 1])
  }
}
